...
const questions = [
    { english: 'July', swahili: 'Julai', image: 'img/months/jul.jpg' },
    { english: 'August', swahili: 'Agosti', image: 'img/months/aug.jpg' },
    { english: 'September', swahili: 'Septemba', image: 'img/months/sep.jpg' },
];
...
document.getElementById('next-btn').addEventListener('click', function() {
    ...
    window.location.href = 'miezi4.html'; // Ensure to create this page
});
